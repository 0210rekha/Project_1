...
im = Image.open(r"D:\Projects\Project_1\YouTube-Logo.png")
...
if web == "DATA ANALYSIS AND VISUALIZATION":
    ...
    if options == "1. What are the names of all the videos and their corresponding channels?":
        if st.button("SUBMIT"):
            conn = mysql.connector.connect(host="localhost", user="root", password="YOUR MYSQL PASSWORD", database="youtube")
            my_cursor = conn.cursor()
